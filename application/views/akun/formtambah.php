          ...
          <div class="span12">
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                ...
                <br>
                <form action="<?=base_url()?>c_akun/tambah_akun" role="form" method="post" class="form-horizontal">
                  <div class="control-group primary">
                    <label class="control-label" for="inputWarning">No Akun</label>

                    <div class="controls">
                       <input type="text" class="span6" id="noakun" required name="noakun" />
                  ...
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       <input type="text" class="span6" id="namaakun" required name="namaakun" />
                       <span class="help-inline"></span>
                    </div>
                  </div>
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       ...
                       <option value="0">Non-Beban</option>
